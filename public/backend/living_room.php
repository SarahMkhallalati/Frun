...
$living_room_card='<div class="row">';
  foreach ($living_room_arr as $key => $living_room_furn) 
   {
    $living_room_card .= '<div class="col-lg-4">
                        <div class="card">
                          <img src="'.$living_room_furn["image"].'"class="card-img-top" alt="...">
                          <div class="card-body">
                            <h5 class="card-title">'.$living_room_furn["furn_name"].'</h5>
                            <p class="card-text">width:120cm
                              height:20cm <br>
                              price:'.$living_room_furn["price"].'
                            </p>
