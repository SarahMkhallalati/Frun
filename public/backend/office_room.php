...
$office_room_card='<div class="row">';
  foreach ($office_room_arr as $key => $office_room_furn) 
   {
    $office_room_card .= '<div class="col-lg-4">
                        <div class="card">
                          <img src="'.$office_room_furn["image"].'"class="card-img-top" alt="...">
                          <div class="card-body">
                            <h5 class="card-title">'.$office_room_furn["furn_name"].'</h5>
                            <p class="card-text">width:120cm
                              height:20cm <br>
                              price:'.$office_room_furn["price"].'
                            </p>
