...
var config = {
  mutationFunction: function mutationFunction(phenotype) {
    return phenotype;
  },
  crossoverFunction: function crossoverFunction(a, b) {
    return [a, b];
  },
  fitnessFunction: function fitnessFunction(phenotype) {
    return 0;
  },
...
window.genertic = __webpack_require__(/*! geneticalgorithm */ "./node_modules/geneticalgorithm/index.js");
