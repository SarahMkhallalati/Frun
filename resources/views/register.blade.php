...
<form id="form" method="POST" action="{{route('register')}}">
  ...
  <div class="mb-3">
    ...
    <input type="password" class="form-control" name="password" id="exampleInputPassword1" style="width:300px; box-shadow:1px 1px grey;" required>
  </div>
  <div class="mb-3">
    <label for="exampleInputPassword1"  class="form-label">Confirm Password</label>
    <input type="password" class="form-control" name="confirm_password" id="exampleInputPassword1" style="width:300px; box-shadow:1px 1px grey;">
  </div>
